...
from satquery.model.satquery_arch import SatQueryMetaModel, SatQueryMetaForCausalLM


class SatQueryMPTConfig(MPTConfig):
    model_type = "satquery_mpt"


class SatQueryMPTModel(SatQueryMetaModel, MPTModel):
    config_class = SatQueryMPTConfig

    def __init__(self, config: MPTConfig):
        config.hidden_size = config.d_model
        super(SatQueryMPTModel, self).__init__(config)
    
    def embed_tokens(self, x):
        return self.wte(x)


class SatQueryMPTForCausalLM(MPTForCausalLM, SatQueryMetaForCausalLM):
    config_class = SatQueryMPTConfig
    ...
    def __init__(self, config):
        ...
        self.transformer = SatQueryMPTModel(config)
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, SatQueryMPTModel):
...
AutoConfig.register("satquery_mpt", SatQueryMPTConfig)
AutoConfig.register("satquery_mpt", SatQueryMPTConfig)
AutoModelForCausalLM.register(SatQueryMPTConfig, SatQueryMPTForCausalLM)
