...
[[Project Page]()] [[Code]()] [[Model]()] | 📚 [[]()] [[SatQuery-v1]()]
""")
...
def build_demo(embed_mode):
    ...
    with gr.Blocks(title="RemoteChat", theme=gr.themes.Default(), css=block_css) as demo:
        state = gr.State()
        ...
        with gr.Row():
            ...
            with gr.Column(scale=8):
                chatbot = gr.Chatbot(elem_id="chatbot", label="RemoteChat Bot", height=550)
                with gr.Row():
                    with gr.Column(scale=8):
                        textbox.render()
